...
- [ ] P1 restant : aucune page publique de candidature exposant (`POST /api/exhibitors/apply` existe côté back, jamais consommé côté front) — net-new feature, pas juste du branchement, à ne pas démarrer sans confirmation explicite
