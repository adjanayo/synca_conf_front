      ...
      <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-12 gap-10 items-center">
        <div className="md:col-span-7">
          ...
          <p className="mt-4 text-muted-foreground max-w-xl">
            Six niveaux de partenariat — de 1,5M à 10M F CFA — pour aligner votre marque sur
            l'écosystème tech le plus dynamique du continent : recrutement, visibilité, B2B, impact.
          </p>
        ...
        <div className="md:col-span-5 grid grid-cols-3 gap-3">
          {["Title", "Platinum", "Gold", "Silver", "Bronze", "Média"].map((t) => (
            <div
              key={t}
              className="aspect-square rounded-2xl bg-peach border border-primary/20 flex items-center justify-center text-xs font-bold uppercase tracking-widest text-ink"
            >
              {t}
            </div>
          ))}
